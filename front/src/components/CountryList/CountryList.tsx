...
const CountryList: React.FC = () => {
    ...
    const { domainlink, lastdate, downloads } = location.state
        ...
        <div className="table-container">
            <div style={{ margin: "30px 0px 20px", display: "flex", justifyContent: "space-between" }}>
                <div style={{ display: "flex", gap: "20px" }}>
                    ...
                    <h3 style={{ margin: "0px", display: "flex", alignItems: "center", color: "#339be7" }}>{domainlink}</h3>
                </div>
                <div>
                    <h3 style={{ margin: "0px", display: "flex", justifyContent: "flex-end" }}>Downloads: {downloads}</h3>
                    <h3 style={{ margin: "0px", display: "flex", alignItems: "center" }}>Last Download Date: {lastdate}</h3>
                </div>
            </div>
            <div style={{ display: "flex", gap: "20px" }}>
                <input
